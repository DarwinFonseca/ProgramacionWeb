    ...
    function ConsultarTabla() {
        ...
        $result = mysql_query($query);
            ...
            while ($row = mysql_fetch_array($result)) {
                ...
                echo "<td>" . $row["rol"] . "</td></tr>";
            }
    }

    public function LogIn($validado, $correo, $password) {

      if ($validado=='1') {
        //echo "<br>entro al Script LOGIN<br>";
        $consulta_mysql = 'SELECT * FROM usuarios WHERE correo LIKE  "' .$correo. '" AND password LIKE "' .$password. '"';
        //echo $consulta_mysql;
...
//            echo "<br>¡ Se encontraron resultados !";
          ...
          $this->LogIn($validado, $correo, $password);
    }
